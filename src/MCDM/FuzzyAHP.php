 ...
 *
 * @property  PairwiseComparisonMatrixList $pcml
 */
class FuzzyAHP
{
    ...
    /**
     * FuzzyAHP constructor.
     * @param DecisionMaker $dm
     * @param AlternativeList $aL
     * @param PairwiseComparisonMatrixList|null $pcml
     */
    ...
    public function fillAltsAsChildren()
    {
        Utils::objectArrayWalkRecursive(function (&$e, $indexArr) {
            if (!($e instanceof Alternative)) {
                $copier = new DeepCopy();
                if ($e->children == null) {
                    $e->children = $copier->copy($this->aL);
                }
            }
    ...
    /**
     * @return PairwiseComparisonMatrixList
     */
